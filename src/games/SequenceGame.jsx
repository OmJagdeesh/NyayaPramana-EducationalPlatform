          ...
          {selected.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                {feedback && <div style={{ fontSize: 18 }}>{isItemCorrect ? '✅' : '❌'}</div>}
              </div>
            );
          })}
          ...
          <div className="glass" style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            {scrambled.map((item, idx) => (
              <div
                ...
                style={{ padding: 14, background: 'rgba(10,191,188,0.08)', border: '1px solid rgba(10,191,188,0.3)', borderRadius: 8, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 14, transition: 'transform 0.15s' }}
